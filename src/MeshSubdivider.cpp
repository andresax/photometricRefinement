...
void MeshSubdivider::subdivide(MeshSurface &p, glm::mat4 cameraMatrix) {
  ...
  for (auto he : p.halfedges()) {
    ...
    std::cout << "halfedge--------------------------------------:" << location[vSource] << "++ " << location[vTarget] << std::endl;
    ...
    if (toCheck) {
      ...
      float area = 0.5 * glm::abs(orientPoint(pt2D_1, pt2D_2, pt2D_3));
       std::cout<<"/////////////////////////-"<<pt2D_1.x<<"-"<<pt2D_1.y<<std::endl;
       std::cout<<"/////////////////////////-"<<pt2D_2.x<<"-"<<pt2D_2.y<<std::endl;
       std::cout<<"/////////////////////////-"<<pt2D_3.x<<"-"<<pt2D_3.y<<std::endl;
  ...
  std::cout << "*************************..." << eiv.size() << " " << p.has_garbage() << std::endl;
